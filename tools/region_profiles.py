...
SOUTH_AWS_STATIONS = {
    ...
    '과천': [(116, '관악(레)'), (590, '과천')],
    # 성남·평택은 소방서가 둘로 나뉜다(성남/분당, 평택/송탄). 경기 전체 사이트가
    # 소방서 단위라 관측소를 관할대로 쪼갠다. 경기남부 사이트는 시군 21개 그대로라
    # '분당'·'송탄' 키는 그쪽에선 안 쓰인다(일산이 북부에서 그런 것과 같은 구조).
    '성남': [(572, '성남')],
    '분당': [(364, '분당구')],
    ...
    '평택': [(356, '고덕면'), (358, '현덕면'), (374, '청북'), (472, '포승'), (551, '평택')],
